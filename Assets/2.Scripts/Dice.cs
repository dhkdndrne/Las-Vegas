...
public class Dice : MonoBehaviourPun, IPunObservable
{
	...
	private Subject<Unit> activateDiceSubject = new();
	...
	private void FixedUpdate()
	{
		if (!pv.IsMine)
		{
			...
			rigidBody.rotation = Quaternion.RotateTowards(rigidBody.rotation, qtNetworkRot, Time.fixedDeltaTime * 100f);
		}
	}
	...
	public async UniTaskVoid Roll()
	{
		...
		rigidBody.angularVelocity = Random.insideUnitSphere * 3000;

		await UniTask.WaitUntil(()=>rigidBody.velocity.sqrMagnitude < 0.001f);
